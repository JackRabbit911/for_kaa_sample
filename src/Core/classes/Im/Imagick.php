...
class Imagick extends Im {
	...
	public static function check()
	{
		...
		{
			throw new WnException('Imagick is not installed, or the extension is not loaded');
		}

		return Imagick::$_checked = TRUE;
	}
	...
	protected function _get_imagetype($extension)
	{
		...
		switch ($format)
		{
			...
			break;
			default:
				throw new WnException('Installed ImageMagick does not support :type images',
