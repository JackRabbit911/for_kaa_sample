...
class GD extends Im {
	...
	public static function check()
	{
		...
		{
			throw new WnException('GD is either not installed or not enabled, check your configuration');
		}
		$functions = array(
			GD::IMAGEROTATE,
			GD::IMAGECONVOLUTION,
		...
		{
			throw new WnException('Image_GD requires GD version :required or greater, you have :version',
	...
	public function __construct($file)
	{
		...
		{
			throw new WnException('Installed GD does not support :type images',
	...
	{
		if (empty(GD::$_available_functions[GD::IMAGEROTATE]))
		{
			throw new WnException('This method requires :function, which is only available in the bundled version of GD',
	...
	{
		if (empty(GD::$_available_functions[GD::IMAGECONVOLUTION]))
		{
			throw new WnException('This method requires :function, which is only available in the bundled version of GD',
	...
	{
		if (empty(GD::$_available_functions[GD::IMAGEFILTER]))
		{
			throw new WnException('This method requires :function, which is only available in the bundled version of GD',
	 ...
	 * @return  void
	 */
	protected function _do_watermark(Im $watermark, $offset_x, $offset_y, $opacity)
	{
